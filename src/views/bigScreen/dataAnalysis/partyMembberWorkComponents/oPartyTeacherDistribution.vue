<template>
    <div id="oPartyTeacherDistribution">
        <div class="bg-color-black">
            <div class="d-flex pt-2 pl-2">
                ...
                <div class="d-flex">
                    <span class="text mx-2">各学院党委教职工党员人数TOP5</span>
...
export default {
    name: 'oPartyTeacherDistribution',
    data() {
        return {
            barChart: null,
        };
    ...
    mounted() {
        ...
        methods: {
            initBarChart() {
                ...
                service.get("organization/partyTeacherDistribution") // 假设后端接口地址为/api/barChartData
                .then((response) => { 
                        ...
                        series: [{
                                ...
                                normal: {
                                    color: {
                                        ...
                                        colorStops: [ // 颜色停靠点
                                            ...
                                            { offset: 0, color: '#FFD700' } // 偏移量1表示渐变终点
                                        ],
                            ...
                            label: {
                                ...
                                formatter: function (params) {
                                    // console.log(params)
                                    // (item.rate* 100).toFixed(2)
                                    return params.value+"人"+"\n"+"(占"+(data[params.dataIndex].rate*100).toFixed(2)+ '%'+")";// 显示 rate 计算后的值
                                }
                            },
                        }]
                    }
                    ...
                    barChart.on('click', (params) =>{
                      if(params.componentType==="series"){
                        this.$router.push({ name: 'partyMembberWork-oPartyTeacherDetail', query: { name: params.name, } })
                      }
                    });
                }).catch((error) => {
