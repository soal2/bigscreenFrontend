<template>
    <div id="oJnTimeDetail">
        <el-backtop></el-backtop>
        <div class="bg">
            <div class="nav">
                <h2>党费缴纳情况-2024欠缴人数Top5-{{ name }}&nbsp;</h2>
            </div>
            <div>
                ...
                <div style="padding-left: 4%;padding-right: 4%;">
                    <el-table :data="data1" style="width: 98%" :header-cell-style="{ textAlign: 'center' }"
                        ...
                        <el-table-column prop="code" label="学/工号" style="width: 20%;"></el-table-column>
                        <el-table-column prop="name" label="姓名" style="width: 20%;"></el-table-column>
                        <el-table-column prop="party" label="所属党委" style="width: 20%;"></el-table-column>
                        <el-table-column prop="duePay" label="应缴党费" style="width: 20%;"></el-table-column>
...
export default {
    ...
    methods: {
        ...
        async loadData() {
            try{
                const response = await service.get("organization/noPayNumTop5Detail", {
                    params: {
                ...
                this.data1 = rr.content.map(item => item);
