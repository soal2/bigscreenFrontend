<template>
    <div id="oActiveTop10Distribution">
        <div class="bg-color-black">
            <div class="d-flex pt-2 pl-2">
                ...
                <div class="d-flex">
                    <span class="text mx-2">入党积极分子TOP10</span>
    ...
    mounted() {
        ...
        methods: {
            initBarChart() {
                ...
                service.get("organization/activeTop10Distribution") // 假设后端接口地址为/api/barChartData
                .then((response) => { 
                                ...
                                normal: {
                                    color: {
                                        ...
                                        colorStops: [ // 颜色停靠点
                                            ...
                                            { offset: 0, color: '#EE6666' } // 偏移量1表示渐变终点
                                        ],
                    ...
                    barChart.on('click', (params) =>{
                      if(params.componentType==="series"){
                        this.$router.push({ name: 'partyMembberWork-oActiveTop10Detail', query: { name: params.name, } })
                      }
                    });
                }).catch((error) => {
