<template>
    <div id="oPositiveTop5Distribution">
        <div class="bg-color-black">
            <div class="d-flex pt-2 pl-2">
                ...
                <div class="d-flex">
                    <span class="text mx-2">2024年转正排名TOP5</span>
...
export default {
    name: 'oPositiveTop5Distribution',
    data() {
        return {
            barChart: null,
        };
    ...
    mounted() {
        ...
        methods: {
            initBarChart() {
                ...
                service.get("organization/positiveTop5Distribution") // 假设后端接口地址为/api/barChartData
                .then((response) => { 
                    ...
                    barChart.on('click', (params) =>{
                      if(params.componentType==="series"){
                        this.$router.push({ name: 'partyMembberWork-oPositiveTop5Detail', query: { name: params.name, } })
                      }
                    });
                }).catch((error) => {
