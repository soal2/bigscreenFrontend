            ...
            <div>
                ...
                <div style="padding-left: 4%;padding-right: 4%;">
                    <el-table :data="data1" style="width: 98%" :header-cell-style="{ textAlign: 'center' }"
                        ...
                        <el-table-column prop="code" label="工号" style="width: 20%;"></el-table-column>
                        ...
                        <el-table-column prop="branch" label="所属支部" style="width: 20%;"></el-table-column>
...
export default {
    ...
    methods: {
        ...
        async loadData() {
            try{
                const response = await axios.get("http://localhost:8080/organization/activeTimeDetail", {
                    params: {
