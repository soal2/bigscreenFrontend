<template>
    <div id="educationDetail" style="background-color: black; width: 100%; height: 100vh">
        <div class="bg">
            <el-backtop></el-backtop>
            <div>
                <div class="nav">
                    <h2>在校教职工学历分布-{{ name1 }}-{{ name2 }}</h2>
                </div>
                <div>
...
export default {
    ...
    methods: {
        ...
        async loadData() {
            let rr = null
            await service
                .get('teachingStaff/educationDetail', { params: { page: this.currentPage - 1, size: this.pageSize, name1: this.name1, name2: this.name2 } })
                .then(
                    res => {
