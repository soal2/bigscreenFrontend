<template>
    <div id="recent5YearsEntryDetail" style="background-color: black; width: 100%; height: 100vh">
        <div class="bg">
            <el-backtop></el-backtop>
            <div>
                <div class="nav">
                    <h2>近五年人员变动情况-{{ year }}年-{{ name }}入职</h2>
                </div>
                <div>
...
export default {
    ...
    methods: {
        ...
        async loadData() {
            let rr = null
            await service
                .get('teachingStaff/recent5YearsEntryDetail', { params: { page: this.currentPage - 1, size: this.pageSize, name: this.name, year: this.year } })
                .then(
                    res => {
