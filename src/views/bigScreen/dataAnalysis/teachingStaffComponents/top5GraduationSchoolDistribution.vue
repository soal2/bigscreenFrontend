<template>
    <div id="top5GraduationSchoolDistribution">
        <div class="bg-color-black">
            <div class="d-flex pt-2 pl-2">
                ...
                <div class="d-flex">
                    <span class="text mx-2">教职工毕业院校Top5</span>
...
export default {
    name: 'Top5GraduationSchoolDistribution',
    data() {
        return {
            chart1: null,
            xLabel: [],
    ...
    methods: {
        ...
        async initLoadData() {
            let rr = null
            await service
                .get('teachingStaff/top5GraduationSchoolDistribution')
                .then(
                    res => {
                        console.log(res.data)
                        rr = res.data
                        console.log("load top5GraduationSchoolDistribution success")
                    }
                )
                .catch(failResponse => {
        ...
        initCharts() {
            ...
            this.chart1.on('click', function (params) {
                if (params.componentType === "series") {
                    ...
                    _this.$router.push({ name: 'TeachingStaff-Top5GraduationSchoolDetail', query: { name: params.name,} })
                }
            });
        },
    }
