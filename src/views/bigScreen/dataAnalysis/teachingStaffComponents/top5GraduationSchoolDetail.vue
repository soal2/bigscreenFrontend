<template>
    <div id="top5GraduationSchoolDetail" style="background-color: black; width: 100%; height: 100vh">
        <div class="bg">
            <el-backtop></el-backtop>
            <div>
                <div class="nav">
                    <h2>教职工毕业院校Top5-{{ name }}&nbsp;</h2>
                </div>
                <div>
...
export default {
    name: 'Top5GraduationSchoolDetail',
    data() {
        return {
            name: null,
            data1: [],
    ...
    methods: {
        ...
        async loadData() {
            let rr = null
            await service
                .get('teachingStaff/top5GraduationSchoolDetail', { params: { page: this.currentPage - 1, size: this.pageSize, name: this.name } })
                .then(
                    res => {
