<template>
    <div id="top5CityProvinceDistribution">
        <div class="bg-color-black">
            <div class="d-flex pt-2 pl-2">
                ...
                <div class="d-flex">
                    <span class="text mx-2">教职工省市来源分布</span>
...
export default {
    name: 'Top5CityProvinceDistribution',
    data() {
        return {
            chart1: null,
            xLabel1: [],
    ...
    methods: {
        ...
        async initLoadData() {
            let rr1 = null
            await service
                .get('teachingStaff/top5CityDistribution')
                .then(
                    res => {
                        console.log(res.data)
                        rr1 = res.data
                        console.log("load top5CityDistribution success")
                    }
                )
                .catch(failResponse => {
            ...
            let rr2 = null
            await service
                .get('teachingStaff/top5ProvinceDistribution')
                .then(
                    res => {
                        console.log(res.data)
                        rr2 = res.data
                        console.log("load top5ProvinceDistribution success")
                    }
                )
                .catch(failResponse => {
                    console.log("error", failResponse)
        ...
        initCharts() {
            ...
            this.chart2.on('click', function (params) {
                if (params.componentType === "series") {
                    console.log("点击了" + params.componentType + params.name);
                    _this.$router.push({ name: 'TeachingStaff-Top5ProvinceDetail', query: { name: params.name, } })
                }
            });
        },
    }
