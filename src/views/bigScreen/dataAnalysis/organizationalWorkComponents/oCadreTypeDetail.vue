            ...
            <div>
                ...
                <div style="padding-left: 4%;padding-right: 4%;">
                    <el-table :data="data1" style="width: 98%" :header-cell-style="{ textAlign: 'center' }"
                        ...
                        <el-table-column prop="unit" label="所属学院" style="width: 25%;"></el-table-column>
...
export default {
    ...
    methods: {
        ...
        async loadData() {
            ...
            try{
                const response = await service.get("organization/unitTypeDetail", {
                    params: {
