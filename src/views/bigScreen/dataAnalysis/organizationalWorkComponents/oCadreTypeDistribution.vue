  ...
  export default {
    ...
    methods: {
        initPieChart() {
            ...
            service.get("organization/unitTypeDistribution") // 假设后端接口地址为/api/barChartData
            .then((response) => { 
                ...
                this.data1 = data.map(item => item.value);
                ...
                pieChart.on('click', (params) =>{
                  if(params.componentType==="series"){
                    this.$router.push({ name: 'OrganizationalWork-oCadreTypeDetail', query: { name: data[params.dataIndex].name, } })
                  }
                });
            }).catch((error) => {
