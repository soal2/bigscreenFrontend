<template>
    <div id="provincialMinisterialScientificResearchPlatformDistribution">
        <div class="bg-color-black">
            <div class="d-flex pt-2 pl-2">
                ...
                <div class="d-flex">
                    <span class="text mx-2">省部级科研平台</span>
...
export default {
    name: 'ProvincialMinisterialScientificResearchPlatformDistribution',
    data() {
        return {
            chart: null,
            legendClass: ['省部级科研平台'],
        ...
        initCharts() {
            ...
            this.chart.on('click', function (params) {
                if (params.componentType === "series") {
                    ...
                    _this.$router.push({ name: 'DevelopmentPlanning-ProvincialMinisterialScientificResearchPlatformDetail', query: { name: params.name, } })
                }
            });
        },
    }
...
#provincialMinisterialScientificResearchPlatformDistribution {
    ...
    .body-box {
        ...
        .dv-bar-chart {
            padding-top: 20px;
            width: 100%;
            height: 390px; // Adjust based on the available space
            margin-bottom: 2px;
        }
    }
}
