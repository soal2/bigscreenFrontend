<template>
    <div id="teacherVirtueCultivationDistribution">
        <div class="bg-color-black">
            <div class="d-flex pt-2 pl-2">
                ...
                <div class="d-flex">
                    <span class="text mx-2">师德师风建设（模范先进老师）</span>
...
export default {
    name: 'TeacherVirtueCultivationDistribution',
    data() {
        return {
            chart: null,
            legendClass: ['师德师风建设（模范先进老师）'],
            xLabel: [],
            yData: [],
            data: [],
            dataItem: {
            ...
            */
            ...
            this.chart.on('click', function (params) {
                if (params.componentType === "series") {
                    ...
                    _this.$router.push({ name: 'DevelopmentPlanning-TeacherVirtueCultivationDetail', query: { name: params.name, } })
                }
            });
        },
    }
...
#teacherVirtueCultivationDistribution {
    ...
    .body-box {
        ...
        .dv-bar-chart {
            padding-top: 20px;
            width: 100%;
            height: 300px; // Adjust based on the available space
            margin-bottom: 2px;
        }
    }
}
