<template>
    <div id="modelAdvancedStudentDetail" style="background-color: black; width: 100%; height: 100vh">
        <div class="bg">
                ...
                <div>
                    ...
                    <div style="padding-left: 4%;padding-right: 4%;">
                        <el-table :data="data1" style="width: 98%" :header-cell-style="{ textAlign: 'center' }"
                            ...
                            -->
                            <el-table-column prop="achievementCategory" label="成果类别"></el-table-column>
                            <el-table-column prop="time" label="获得时间" width="200"></el-table-column>
                            <el-table-column prop="person" label="完成人" width="120"></el-table-column>
                            <el-table-column prop="unit" label="完成单位" width="300"></el-table-column>
                            <el-table-column prop="approvalDepartment" label="批准部门" width="160"></el-table-column>
...
export default {
    name: 'ModelAdvancedStudentDetail',
    data() {
        return {
            name: null,
            data1: [],
    ...
    methods: {
        ...
        async loadData() {
            let rr = null
            await service
                .get('developmentPlanning/modelStudent', { params: { subject: this.name } })
                .then(
                    res => {
