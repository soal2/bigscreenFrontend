<template>
    <div id="nationalLevelCoursesDistribution">
        <div class="bg-color-black">
            <div class="d-flex pt-2 pl-2">
                ...
                <div class="d-flex">
                    <span class="text mx-2">国家级一流课程</span>
...
export default {
    name: 'NationalLevelCoursesDistribution',
    data() {
        return {
            chart: null,
            legendClass: ['国家级一流课程'],
        ...
        initCharts() {
            ...
            this.chart.on('click', function (params) {
                if (params.componentType === "series") {
                    ...
                    _this.$router.push({ name: 'DevelopmentPlanning-NationalLevelCoursesDetail', query: { name: params.name, } })
                }
            });
        },
    }
...
#nationalLevelCoursesDistribution {
    ...
    .body-box {
        ...
        .dv-bar-chart {
            padding-top: 20px;
            width: 100%;
            height: 340px; // Adjust based on the available space
            margin-bottom: 2px;
        }
    }
}
