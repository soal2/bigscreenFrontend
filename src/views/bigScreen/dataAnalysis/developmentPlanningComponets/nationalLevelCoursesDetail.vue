<template>
    <div id="nationalLevelCoursesDetail" style="background-color: black; width: 100%; height: 100vh">
        <div class="bg">
                ...
                <div>
                    ...
                    <div style="padding-left: 4%;padding-right: 4%;">
                        <el-table :data="data1" style="width: 98%" :header-cell-style="{ textAlign: 'center' }"
                            ...
                            <el-table-column prop="person" label="主持人姓名" width="120"></el-table-column>
                            <el-table-column prop="type" label="建设类型" width="120"></el-table-column>
                            <el-table-column prop="level" label="级别" width="120"></el-table-column>
                            <el-table-column prop="time" label="批准时间" width="120"></el-table-column>
                            <el-table-column prop="school" label="学院" width="120"></el-table-column>
...
export default {
    name: 'NationalLevelCoursesDetail',
    data() {
        return {
            name: null,
            data1: [],
    ...
    methods: {
        ...
        async loadData() {
            let rr = null
            await service
                .get('developmentPlanning/nationalEliteCourse', { params: { subject: this.name } })
                .then(
                    res => {
