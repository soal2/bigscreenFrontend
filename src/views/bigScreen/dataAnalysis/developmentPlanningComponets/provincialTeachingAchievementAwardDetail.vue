<template>
    <div id="provincialTeachingAchievementAwardDetail" style="background-color: black; width: 100%; height: 100vh">
        <div class="bg">
                ...
                <div>
                    ...
                    <div style="padding-left: 4%;padding-right: 4%;">
                        <el-table :data="data1" style="width: 98%" :header-cell-style="{ textAlign: 'center' }"
                            ...
                            <el-table-column prop="person" label="主要完成人"></el-table-column>
                            <el-table-column prop="level" label="获奖等级" width="120"></el-table-column>
                            <el-table-column prop="time" label="获得时间" width="120"></el-table-column>
                            <el-table-column prop="unit" label="完成单位" width="120"></el-table-column>
                            <el-table-column prop="approvalDepartment" label="批准部门" width="180"></el-table-column>
...
export default {
    name: 'ProvincialTeachingAchievementAwardDetail',
    data() {
        return {
            name: null,
            data1: [],
    ...
    methods: {
        ...
        async loadData() {
            let rr = null
            await service
                .get('developmentPlanning/provinceTeachingAchievement', { params: { subject: this.name } })
                .then(
                    res => {
...
#provincialTeachingAchievementAwardDetail {
    .nav {
        overflow: hidden;
