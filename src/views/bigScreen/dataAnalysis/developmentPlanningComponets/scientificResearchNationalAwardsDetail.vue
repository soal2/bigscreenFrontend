<template>
    <div id="scientificResearchNationalAwardsDetail" style="background-color: black; width: 100%; height: 100vh">
        <div class="bg">
            <el-backtop></el-backtop>
            <div>
                <div class="nav">
                    <h2>科学研究情况-国家级科研奖励-{{ name }}&nbsp;</h2>
                </div>
                <div>
...
export default {
    name: 'ScientificResearchNationalAwardsDetail',
    data() {
        return {
            name: null,
            data1: [],
    ...
    methods: {
        ...
        async loadData() {
            let rr = null
            await service
                .get('developmentPlanning/nationalPrize', { params: { subject: this.name } })
                .then(
                    res => {
...
#scientificResearchNationalAwardsDetail {
    .nav {
        overflow: hidden;
