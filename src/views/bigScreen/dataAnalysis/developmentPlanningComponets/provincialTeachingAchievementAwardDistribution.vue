<template>
    <div id="provincialTeachingAchievementAwardDistribution">
        <div class="bg-color-black">
            <div class="d-flex pt-2 pl-2">
                ...
                <div class="d-flex">
                    <span class="text mx-2">江苏省教学成果奖</span>
...
export default {
    name: 'ProvincialTeachingAchievementAwardDistribution',
    data() {
        return {
            chart: null,
            legendClass: ['江苏省教学成果奖'],
            xLabel: [],
            yData: [],
            data: [],
            dataItem: {
        ...
        initCharts() {
            ...
            this.chart.on('click', function (params) {
                if (params.componentType === "series") {
                    ...
                    _this.$router.push({ name: 'DevelopmentPlanning-ProvincialTeachingAchievementAwardDetail', query: { name: params.name, } })
                }
            });
        },
    }
