<template>
    <div id="scientificResearchProvincialAwardsDetail" style="background-color: black; width: 100%; height: 100vh">
        <div class="bg">
            <el-backtop></el-backtop>
            <div>
                <div class="nav">
                    <h2>科学研究情况-省部级科研奖励-{{ name }}&nbsp;</h2>
                </div>
                <div>
                    ...
                    <div style="padding-left: 4%;padding-right: 4%;">
                        <el-table :data="data1" style="width: 98%" :header-cell-style="{ textAlign: 'center' }"
                            ...
                            <el-table-column prop="name" label="成果名称" width="260"></el-table-column>
                            <el-table-column prop="unit" label="完成单位" width="120"></el-table-column>
                            <el-table-column prop="prizeType" label="奖励类别" width="100"></el-table-column>
                            <el-table-column prop="prize" label="奖项" width="240"></el-table-column>
                            <el-table-column prop="prizeLevel" label="奖励等级" width="100"></el-table-column>
                            <el-table-column prop="person" label="主要完成人员"></el-table-column>
                            <el-table-column prop="cooperativeUnits" label="合作单位" width="140"></el-table-column>
...
export default {
    name: 'ScientificResearchProvincialAwardsDetail',
    data() {
        return {
            name: null,
            data1: [],
    ...
    methods: {
        ...
        async loadData() {
            let rr = null
            await service
                .get('developmentPlanning/provincialPrize', { params: { subject: this.name } })
                .then(
                    res => {
        ...
        // 返回原始大屏
        returnBigScreen() {
            this.$router.push({ name: 'BigScreen-DevelopmentPlanning' })
        }
...
#scientificResearchProvincialAwardsDetail {
    .nav {
        overflow: hidden;
