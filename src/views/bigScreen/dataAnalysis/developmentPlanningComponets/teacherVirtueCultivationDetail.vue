<template>
    <div id="teacherVirtueCultivationDetail" style="background-color: black; width: 100%; height: 100vh">
        <div class="bg">
            <el-backtop></el-backtop>
            <div>
                <div class="nav">
                    <h2>国家级师德师风先进-{{ name }}&nbsp;</h2>
                </div>
                <div>
                    ...
                    <div style="padding-left: 4%;padding-right: 4%;">
                        <el-table :data="data1" style="width: 98%" :header-cell-style="{ textAlign: 'center' }"
                            ...
                            <el-table-column prop="name" label="奖项名称" width="300"></el-table-column>
                            <el-table-column prop="time" label="获得时间" width="120"></el-table-column>
                            <el-table-column prop="person" label="完成人"></el-table-column>
                            <el-table-column prop="unit" label="完成单位" width="120"></el-table-column>
                            <el-table-column prop="approvalDepartment" label="批准部门" width="300"></el-table-column>
...
export default {
    name: 'TeacherVirtueCultivationDetail',
    data() {
        return {
            name: null,
            data1: [],
    ...
    methods: {
        ...
        async loadData() {
            let rr = null
            await service
                .get('developmentPlanning/nationalAdvancedEthic', { params: { subject: this.name } })
                .then(
                    res => {
...
#teacherVirtueCultivationDetail {
    .nav {
        overflow: hidden;
