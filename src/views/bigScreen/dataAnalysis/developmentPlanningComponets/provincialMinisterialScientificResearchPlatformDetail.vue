<template>
    <div id="provincialMinisterialScientificResearchPlatformDetail"
        style="background-color: black; width: 100%; height: 100vh">
        <div class="bg">
                ...
                <div>
                    ...
                    <div style="padding-left: 4%;padding-right: 4%;">
                        <el-table :data="data1" style="width: 98%" :header-cell-style="{ textAlign: 'center' }"
                            ...
                            <el-table-column prop="time" label="立项日期" width="120"></el-table-column>
                            <el-table-column prop="school" label="所属学院" width="120"></el-table-column>
                            <el-table-column prop="director" label="实验室主任" width="120"></el-table-column>
                            <el-table-column prop="leadUnit" label="牵头单位" width="160"></el-table-column>
...
export default {
    name: 'ProvincialMinisterialScientificResearchPlatformDetail',
    data() {
        return {
            name: null,
            data1: [],
    ...
    methods: {
        ...
        async loadData() {
            let rr = null
            await service
                .get('developmentPlanning/ministerialPlatform', { params: { subject: this.name } })
                .then(
                    res => {
            ...
            let rr2 = null
            await service
                .get('developmentPlanning/provincialPlatformExcel', { params: { subject: this.name } })
                .then(
                    res => {
                        console.log(res.data)
                        rr2 = res.data
...
#provincialMinisterialScientificResearchPlatformDetail {
    .nav {
        overflow: hidden;
