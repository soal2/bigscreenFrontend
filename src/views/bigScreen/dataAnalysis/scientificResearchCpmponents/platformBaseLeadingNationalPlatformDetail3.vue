<template>
    <div id="platformBaseLeadingNationalPlatformDetail3" style="background-color: black; width: 100%; height: 100vh">
        <div class="bg">
            <el-backtop></el-backtop>
            <div>
                <div class="nav">
                    <h2>科研平台和哲社基地情况-牵头国家级科研平台-{{ year }}&nbsp;</h2>
                </div>
                <div>
...
export default {
    name: 'PlatformBaseLeadingNationalPlatformDetail3',
    data() {
        return {
            name: null,
            year: null,
    ...
    methods: {
        ...
        async loadData() {
            let rr = null
            await service
                .get('scientificResearch/researchLeadingNationalPlatforms/detail', { params: { year: this.year } })
                .then(
                    res => {
...
#platformBaseLeadingNationalPlatformDetail3 {
    .nav {
        overflow: hidden;
