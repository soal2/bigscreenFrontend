<template>
    <div id="researchProjectFundingDetail3" style="background-color: black; width: 100%; height: 100vh">
        <div class="bg">
            ...
            <div>
                ...
                <div>
                    <div style="padding-left: 82%; padding-top: 12px;padding-bottom: 10px;">
                        <el-button type="primary" @click="returnBigScreen">返回科研看板</el-button>
                    </div>
                    <div style="padding-left: 4%;padding-right: 4%;">
                        <el-table :data="data1" style="width: 98%" :header-cell-style="{ textAlign: 'center' }"
                            ...
                            <el-table-column prop="value" label="经费（亿元）"></el-table-column>
                            <!--
...
export default {
    name: 'ResearchProjectFundingDetail3',
    data() {
        return {
            name: null,
            data1: [],
    ...
    methods: {
        ...
        async loadData() {
            let rr = null
            await service
                .get('scientificResearch/researchFunds', { params: { year: this.name } })
                .then(
                    res => {
