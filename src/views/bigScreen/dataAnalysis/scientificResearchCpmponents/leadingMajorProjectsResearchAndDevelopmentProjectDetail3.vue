<template>
    <div id="leadingMajorProjectsResearchAndDevelopmentProjectDetail3" style="background-color: black; width: 100%; height: 100vh">
        <div class="bg">
            <el-backtop></el-backtop>
            <div>
                <div class="nav">
                    <h2>重大重点项目-牵头国家科技重大专项-{{ year }}&nbsp;</h2>
                </div>
                <div>
                    ...
                    <div style="padding-left: 4%;padding-right: 4%;">
                        <el-table :data="data1" style="width: 98%" :header-cell-style="{ textAlign: 'center' }"
                            ...
                            <el-table-column prop="projectOrSubject" label="项目/课题" width="100"></el-table-column>
                            <el-table-column prop="type" label="类别" width="180"></el-table-column>
                            <el-table-column prop="specialName" label="专项名称" width="200"></el-table-column>
                            <el-table-column prop="projectName" label="项目名称"></el-table-column>
                            <el-table-column prop="unit" label="学院" width="120"></el-table-column>
                            <el-table-column prop="person" label="项目负责人" width="120"></el-table-column>
...
export default {
    name: 'LeadingMajorProjectsResearchAndDevelopmentProjectDetail3',
    data() {
        return {
            name: null,
            year: null,
    ...
    methods: {
        ...
        async loadData() {
            let rr = null
            await service
                .get('scientificResearch/researchLeadingMajorProjects/detail', { params: { year: this.year } })
                .then(
                    res => {
...
#leadingMajorProjectsResearchAndDevelopmentProjectDetail3 {
    .nav {
        overflow: hidden;
