<template>
    <div id="technologyAchievementAwardsProvincialDetail3" style="background-color: black; width: 100%; height: 100vh">
        <div class="bg">
            <el-backtop></el-backtop>
            <div>
                <div class="nav">
                    <h2>科技成果奖项情况-省部级科技成果一等奖（项）-{{ year }}&nbsp;</h2>
                </div>
                <div>
                    ...
                    <div style="padding-left: 4%;padding-right: 4%;">
                        <el-table :data="data1" style="width: 98%" :header-cell-style="{ textAlign: 'center' }"
                            ...
                            <el-table-column prop="name" label="成果名称" width="160"></el-table-column>
                            <el-table-column prop="unit" label="完成单位" width="120"></el-table-column>
                            <el-table-column prop="prizeType" label="奖励类别" width="80"></el-table-column>
                            <el-table-column prop="prize" label="奖项" width="180"></el-table-column>
                            <el-table-column prop="prizeLevel" label="奖励等级" width="80"></el-table-column>
                            <el-table-column prop="mainPersons" label="主要完成人员"></el-table-column>
                            <el-table-column prop="cooperativeUnits" label="合作单位" width="160"></el-table-column>
                            <el-table-column prop="independentFunding" label="受自主科研资助" width="80"></el-table-column>
                            <!--
...
export default {
    name: 'TechnologyAchievementAwardsProvincialDetail3',
    data() {
        return {
            name: null,
            year: null,
    ...
    methods: {
        ...
        async loadData() {
            let rr = null
            await service
                .get('scientificResearch/researchProvincialTechnologyAwards/detail', { params: { year: this.year } })
                .then(
                    res => {
...
#technologyAchievementAwardsProvincialDetail3 {
    .nav {
        overflow: hidden;
