<template>
    <div id="platformBaseProvincialPlatformDetail3" style="background-color: black; width: 100%; height: 100vh">
        <div class="bg">
            <el-backtop></el-backtop>
            <div>
                <div class="nav">
                    <h2>科研平台和哲社基地情况-新增省部级科研平台-{{ year }}&nbsp;</h2>
                </div>
                <div>
                    ...
                    <div style="padding-left: 4%;padding-right: 4%;">
                        <el-table :data="data1" style="width: 98%" :header-cell-style="{ textAlign: 'center' }"
                            ...
                            <el-table-column prop="initiationTime" label="立项日期" width="150"></el-table-column>
                            <el-table-column prop="researchTime" label="建设期/评估周期" width="200"></el-table-column>
...
export default {
    name: 'PlatformBaseProvincialPlatformDetail3',
    data() {
        return {
            name: null,
            year: null,
    ...
    methods: {
        ...
        async loadData() {
            let rr = null
            await service
                .get('scientificResearch/researchProvincialPlatforms/detail', { params: { year: this.year } })
                .then(
                    res => {
...
#platformBaseProvincialPlatformDetail3 {
    .nav {
        overflow: hidden;
