<template>
    <div id="technologyAchievementAwardsNationalDetail3" style="background-color: black; width: 100%; height: 100vh">
        <div class="bg">
            <el-backtop></el-backtop>
            <div>
                <div class="nav">
                    <h2>科技成果奖项情况-国家科技成果奖（项）-{{ year }}&nbsp;</h2>
                </div>
                <div>
...
export default {
    name: 'TechnologyAchievementAwardsNationalDetail3',
    data() {
        return {
            name: null,
            year: null,
    ...
    methods: {
        ...
        async loadData() {
            let rr = null
            await service
                .get('scientificResearch/researchNationalTechnologyAwards/detail', { params: { year: this.year } })
                .then(
                    res => {
...
#technologyAchievementAwardsNationalDetail3 {
    .nav {
        overflow: hidden;
