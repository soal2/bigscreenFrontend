<template>
    <div id="nationalSocialFoundationDistribution">
        <div class="bg-color-black">
            <div class="d-flex pt-2 pl-2">
                ...
                <div class="d-flex">
                    <span class="text mx-2">国家社会科学基金</span>
...
export default {
    name: 'NationalSocialFoundationDistribution',
    data() {
        return {
            chart: null,
            legendClass: ['国家社会科学基金（项）',],
            xLabel: [],
            yData: [],
        };
    },
        ...
        initCharts() {
            ...
            this.chart.on('click', function (params) {
                if (params.componentType === "series") {
                    ...
                    _this.$router.push({ name: 'ScientificResearch-NationalSocialFoundationDetail3', query: { year: params.name, } })
                }
            });
        },
    }
