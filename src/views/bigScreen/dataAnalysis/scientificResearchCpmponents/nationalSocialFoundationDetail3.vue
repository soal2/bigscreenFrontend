<template>
    <div id="nationalSocialFoundationDetail3" style="background-color: black; width: 100%; height: 100vh">
        <div class="bg">
                ...
                <div>
                    ...
                    <div style="padding-left: 4%;padding-right: 4%;">
                        <el-table :data="data1" style="width: 98%" :header-cell-style="{ textAlign: 'center' }"
                            ...
                            <el-table-column prop="projectType" label="项目类别" width="240"></el-table-column>
                            <el-table-column prop="projectName" label="项目名称"></el-table-column>
                            <el-table-column prop="type" label="类别" width="100"></el-table-column>
                            <el-table-column prop="person" label="主持人" width="100"></el-table-column>
                            <el-table-column prop="unit" label="学院" width="150"></el-table-column>
                            <el-table-column prop="initiationTime" label="立项日期" width="100"></el-table-column>
                            <!--
...
export default {
    name: 'NationalSocialFoundationDetail3',
    data() {
        return {
            name: null,
            year: null,
    ...
    methods: {
        ...
        async loadData() {
            let rr = null
            await service
                .get('scientificResearch/researchNationalSocialFunds/detail', { params: { year: this.year } })
                .then(
                    res => {
...
#nationalSocialFoundationDetail3 {
    .nav {
        overflow: hidden;
