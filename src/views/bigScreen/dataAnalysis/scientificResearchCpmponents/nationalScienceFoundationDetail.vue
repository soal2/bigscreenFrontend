<template>
    <div id="nationalScienceFoundationDetail" style="background-color: black; width: 100%; height: 100vh">
        <div class="bg">
            <el-backtop></el-backtop>
            <div>
                <div class="nav">
                    <!--
                    <h2>国家自然科学基金：{{ name }}&nbsp;数据</h2>
                    -->
                    <h2>国家自然科学基金</h2>
                </div>
                <div>
...
export default {
    name: 'NationalScienceFoundationDetail',
    data() {
        return {
            name: null,
        ...
        initCharts() {
            ...
            this.chart.on('click', function (params) {
                if (params.componentType === "series") {
                    ...
                    _this.$router.push({ name: 'ScientificResearch-NationalScienceFoundationDetail3', query: { name: params.name, year: params.seriesName} })
                }
            });
        },
...
#nationalScienceFoundationDetail {
    .nav {
        overflow: hidden;
