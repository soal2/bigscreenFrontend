<template>
    <div id="platformBaseProvincialBaseDetail3" style="background-color: black; width: 100%; height: 100vh">
        <div class="bg">
            <el-backtop></el-backtop>
            <div>
                <div class="nav">
                    <h2>科研平台和哲社基地情况-新增省部级哲社基地-{{ year }}&nbsp;</h2>
                </div>
                <div>
                    ...
                    <div style="padding-left: 4%;padding-right: 4%;">
                        <el-table :data="data1" style="width: 98%" :header-cell-style="{ textAlign: 'center' }"
                            ...
                            <el-table-column prop="department" label="主管部门" width="240"></el-table-column>
                            <el-table-column prop="initiationTime" label="成立时间" width="120"></el-table-column>
                            <el-table-column prop="person" label="负责人" width="120"></el-table-column>
                            <el-table-column prop="unit" label="所在单位" width="180"></el-table-column>
                            <!--
...
export default {
    name: 'PlatformBaseProvincialBaseDetail3',
    data() {
        return {
            name: null,
            year: null,
    ...
    methods: {
        ...
        async loadData() {
            let rr = null
            await service
                .get('scientificResearch/researchPlatformBase/detail', { params: { year: this.year } })
                .then(
                    res => {
...
#platformBaseProvincialBaseDetail3 {
    .nav {
        overflow: hidden;
