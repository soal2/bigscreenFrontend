<template>
    <div id="supervisorTitleAndAgeDetail" style="background-color: black; width: 100%; height: 100vh">
        <div class="bg">
            <el-backtop></el-backtop>
            <div>
                <div class="nav">
                    <h2>导师职级年龄分布-{{ name }}-{{ age }}&nbsp;</h2>
                </div>
                <div>
                    ...
                    <div style="padding-left: 4%;padding-right: 4%;">
                        <el-table :data="data1" style="width: 98%" :header-cell-style="{ textAlign: 'center' }"
                            ...
                            <el-table-column prop="work" label="单位" width="300"></el-table-column>
...
export default {
    name: 'SupervisorTitleAndAgeDetail',
    data() {
        return {
            name: null,
            age: null,
    ...
    methods: {
        ...
        async loadData() {
            let rr = null
            await service
                .get('graduateStudent/supervisorTitleAndAgeDetail', { params: { page: this.currentPage - 1, size: this.pageSize, name: this.name, age: this.age } })
                .then(
                    res => {
