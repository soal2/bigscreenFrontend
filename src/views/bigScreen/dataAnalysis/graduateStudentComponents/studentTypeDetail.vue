<template>
    <div id="studentTypeDetail" style="background-color: black; width: 100%; height: 100vh">
        <div class="bg">
...
export default {
    ...
    methods: {
        ...
        async loadData() {
            let rr = null
            await service
                .get('graduateStudent/studentTypeDetail', { params: { page: this.currentPage - 1, size: this.pageSize, name: this.name } })
                .then(
                    res => {
