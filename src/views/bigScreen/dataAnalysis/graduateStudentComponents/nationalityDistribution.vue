<template>
  <div id="nationalityDistribution">
    <div class="bg-color-black">
      <div class="d-flex pt-2 pl-2">
        ...
        <div class="d-flex">
          <span class="text mx-2">研究生民族分布</span>
...
export default {
  ...
  methods: {
    ...
    async initLoadData() {
      await service
        .get('graduateStudent/nationalityDistribution')
        .then(
          res => {
            console.log(res.data)
            this.data1 = res.data
            console.log("load nationalityDistribution success")
          }
        )
        .catch(failResponse => {
    ...
    initCharts() {
      ...
      this.chart1.on('click', function (params) {
        if (params.componentType === "series") {
          ...
          _this.$router.push({ name: 'GraduateStudent-NationalityDetail', query: { name: params.name, } })
        }
      });
