<template>
    <div id="campusDetail" style="background-color: black; width: 100%; height: 100vh">
        <div class="bg">
            <el-backtop></el-backtop>
            <div>
                <div class="nav">
                    <h2>研究生性别和校区分布-{{ campus }}-{{ name }}&nbsp;</h2>
                </div>
                <div>
...
export default {
    ...
    methods: {
        ...
        async loadData() {
            let rr = null
            await service
                .get('graduateStudent/campusNumDetail', { params: { page: this.currentPage - 1, size: this.pageSize, campus: this.campus, name: this.name, } })
                .then(
                    res => {
