<template>
    <div id="top5StudentHometownProvinceDetail" style="background-color: black; width: 100%; height: 100vh">
        <div class="bg">
            <el-backtop></el-backtop>
            <div>
                <div class="nav">
                    <h2>研究生生源地分布-Top5省份-{{ name }}&nbsp;</h2>
                </div>
                <div>
...
export default {
    name: 'Top5StudentHometownProvinceDetail',
    data() {
        return {
            name: null,
            data1: [],
    ...
    methods: {
        ...
        async loadData() {
            let rr = null
            await service
                .get('graduateStudent/top5StudentHometownProvinceDetail', { params: { page: this.currentPage - 1, size: this.pageSize, name: this.name } })
                .then(
                    res => {
...
#top5StudentHometownProvinceDetail {
    .nav {
        overflow: hidden;
