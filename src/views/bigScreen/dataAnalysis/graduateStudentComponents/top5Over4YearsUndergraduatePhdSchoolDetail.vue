<template>
    <div id="top5Over4YearsUndergraduatePhdSchoolDetail" style="background-color: black; width: 100%; height: 100vh">
        <div class="bg">
            <el-backtop></el-backtop>
            <div>
                <div class="nav">
                    <h2>超期未毕业博士生数量Top5学院-{{ name }}&nbsp;</h2>
                </div>
                <div>
...
export default {
    name: 'Top5Over4YearsUndergraduatePhdSchoolDetail',
    data() {
        return {
            name: null,
            data1: [],
    ...
    methods: {
        ...
        async loadData() {
            let rr = null
            await service
                .get('graduateStudent/top5Over4YearsUndergraduatePhdSchoolDetail', { params: { page: this.currentPage - 1, size: this.pageSize, name: this.name } })
                .then(
                    res => {
...
#top5Over4YearsUndergraduatePhdSchoolDetail {
    .nav {
        overflow: hidden;
