<template>
    <div id="top5StudentHometownCityDetail" style="background-color: black; width: 100%; height: 100vh">
        <div class="bg">
            <el-backtop></el-backtop>
            <div>
                <div class="nav">
                    <h2>研究生生源地分布-省内Top5城市-{{ name }}&nbsp;</h2>
                </div>
                <div>
...
export default {
    name: 'Top5StudentHometownCityDetail',
    data() {
        return {
            name: null,
            data1: [],
    ...
    methods: {
        ...
        async loadData() {
            let rr = null
            await service
                .get('graduateStudent/top5StudentHometownCityDetail', { params: { page: this.currentPage - 1, size: this.pageSize, name: this.name } })
                .then(
                    res => {
