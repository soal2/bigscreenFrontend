<template>
    <div id="top5SchoolStudentDetail" style="background-color: black; width: 100%; height: 100vh">
        <div class="bg">
            <el-backtop></el-backtop>
            <div>
                <div class="nav">
                    <h2>前五大学院硕博分布-{{ school }}-{{ name }}&nbsp;</h2>
                </div>
                <div>
...
export default {
    ...
    methods: {
        ...
        async loadData() {
            let rr = null
            await service
                .get('graduateStudent/top5SchoolStudentNumDetail', { params: { page: this.currentPage - 1, size: this.pageSize, school: this.school, name: this.name, } })
                .then(
                    res => {
