<template>
    <div id="studentSourceSituationDetail" style="background-color: black; width: 100%; height: 100vh">
        <div class="bg">
...
export default {
    name: 'StudentSourceSituationDetail',
    data() {
        return {
            name: null,
            data1: [],
    ...
    methods: {
        ...
        async loadData() {
            let rr = null
            await service
                .get('graduateStudent/studentSourceSituationDetail', { params: { page: this.currentPage - 1, size: this.pageSize, name: this.name } })
                .then(
                    res => {
