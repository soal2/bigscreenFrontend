<template>
    <div id="top5Over4YearsUndergraduatePhdSchoolDistribution">
        <div class="bg-color-black">
            <div class="d-flex pt-2 pl-2">
                ...
                <div class="d-flex">
                    <span class="text mx-2">超期未毕业博士生数量Top5学院</span>
...
export default {
    name: 'Top5Over4YearsUndergraduatePhdSchoolDistribution',
    data() {
        return {
            chart1: null,
            xLabel: [],
    ...
    methods: {
        ...
        async initLoadData() {
            let rr = null
            await service
                .get('graduateStudent/top5Over4YearsUndergraduatePhdSchoolDistribution')
                .then(
                    res => {
                        console.log(res.data)
                        rr = res.data
                        console.log("load top5Over4YearsUndergraduatePhdSchoolDistribution success")
                    }
                )
                .catch(failResponse => {
        ...
        initCharts() {
            ...
            this.chart1.on('click', function (params) {
                if (params.componentType === "series") {
                    ...
                    _this.$router.push({ name: 'GraduateStudent-Top5Over4YearsUndergraduatePhdSchoolDetail', query: { name: params.name, } })
                }
            });
        },
    }
