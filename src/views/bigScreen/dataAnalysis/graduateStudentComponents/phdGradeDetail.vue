<template>
    <div id="phdGradeDetail" style="background-color: black; width: 100%; height: 100vh">
        <div class="bg">
            <el-backtop></el-backtop>
            <div>
                <div class="nav">
                    <h2>博士研究生年级分布-{{ name }}&nbsp;</h2>
                </div>
                <div>
...
export default {
    ...
    methods: {
        ...
        async loadData() {
            let rr = null
            await service
                .get('graduateStudent/gradeDetail/phd', { params: { page: this.currentPage - 1, size: this.pageSize, name: this.name } })
                .then(
                    res => {
