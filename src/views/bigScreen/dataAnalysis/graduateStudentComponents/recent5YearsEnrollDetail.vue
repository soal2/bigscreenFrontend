<template>
    <div id="recent5YearsEnrollDetail" style="background-color: black; width: 100%; height: 100vh">
        <div class="bg">
            <el-backtop></el-backtop>
            <div>
                <div class="nav">
                    <h2>近五年硕博招生人数-{{ year }}年-{{ name }}&nbsp;</h2>
                </div>
                <div>
...
export default {
    ...
    methods: {
        // 异步初始化
        async indexStart() {
            this.year = this.$route.query.year //全日制/非全日制
            this.name = this.$route.query.name //在校硕士/在校博士/来华留学生
        ...
        async loadData() {
            let rr = null
            await service
                .get('graduateStudent/recent5YearsEnrollNumDetail', { params: { page: this.currentPage - 1, size: this.pageSize, year: this.year, name: this.name, } })
                .then(
                    res => {
